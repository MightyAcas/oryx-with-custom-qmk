...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    OSM(MOD_LSFT),  KC_Q,           KC_G,           KC_V,           KC_D,           KC_B,                                           KC_Z,           KC_Y,           KC_DOT,         KC_SCLN,        KC_COMMA,       OSM(MOD_LALT),  
                                                    KC_SPACE,       OSL(1),                                         OSL(2),         QK_REP
  ),
  [1] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    ...
    OSM(MOD_LCTL),  LCTL(KC_Z),     LCTL(KC_C),     LCTL(KC_V),     LCTL(KC_F),     LCTL(KC_A),                                     KC_EQUAL,       KC_1,           KC_2,           KC_3,           KC_EXLM,        KC_TRANSPARENT, 
